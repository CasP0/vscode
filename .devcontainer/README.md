...
## Using `gh pr checkout` in the Development Container

The `gh pr checkout` command allows you to check out a pull request locally within the development container. This can be useful for reviewing changes or testing a pull request before merging it.

### Example

To check out a pull request with the ID `237094` in the development container, use the following command:

```sh
gh pr checkout 237094
```
