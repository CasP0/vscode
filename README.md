...
The `gh pr checkout` command allows you to check out a pull request locally. This can be useful for reviewing changes or testing a pull request before merging it.

### Example

To check out a pull request with the ID `237094`, use the following command:
